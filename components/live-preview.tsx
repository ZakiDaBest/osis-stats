...
export default function LivePreview({ initialData }: { initialData: Data }) {
  ...
  return <main className="min-h-screen overflow-hidden bg-[#100d1f] text-white selection:bg-[#7657e8]">
    <header className="flex items-center justify-between border-b border-white/10 px-6 py-5 sm:px-10 lg:px-16">
      <div className="flex items-center gap-3"><div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#7657e8] text-lg font-black">S</div><div><p className="text-sm font-bold tracking-wide">SMAZA<span className="text-[#a696ff]">16</span></p><p className="text-[10px] uppercase tracking-[.24em] text-white/45">Pemilihan Ketua OSIS</p></div></div>
